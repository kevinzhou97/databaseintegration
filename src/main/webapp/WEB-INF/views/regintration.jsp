...
<SCRIPT>
    ...
    function main(){
        ...
        document.formMain.action="/views/main";
            ...
            <div style="padding: 100px 100px 10px;">
                <form id="formLogin"  name="formLogin" action="" method="post">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="Username" id="Name" style="width: 200px " >
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon">Email</span>
                        <input type="text" class="form-control" name="Username" id="Email" style="width: 200px " >
                    </div>
                    <br>
                    <div class="input-group">
